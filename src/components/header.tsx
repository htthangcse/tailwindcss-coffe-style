...
export default function header() {
  return (
    <div id="root">
      <div className="content-wrapper no-parallax font-Karla text-base mx-auto px-8">
        <header className="py-6 mx-10 w-full max-w-screen-2x">
        ...
        <div className="slider w-full max-w-screen-2xl h-[530px] bg-[url('/img/slider.jpg')] bg-cover bg-no-repeat bg-bottom ">
        ...
        <div className="story flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-4 w-[95%] xl:w-[65%] mx-auto ">
        ...
        <div className="featured-mugs w-[95%] xl:w-[65%] mx-auto">
        ...
        <div className="more-products w-[95%] xl:w-[65%] mx-auto">
        ...
        {/* end more products */}
        <div className="subheadline flex justify-center items-center mb-12">
          <div className="subheadline-deco-line"></div>
      ...
      <div className="parallax">
        <div className="parallax-image bg-[url('/img/parallax.jpg')] "></div>
      </div>
      ...
      <div className="content-wrapper no-parallax font-Karla text-base mx-auto px-8">
        ...
        <div className="lifestyle-stories w-[95%] xl:w-[65%] mx-auto mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-4 lg:gap-4">
